...
export const MokeySvg = ({ className }: MonkeyProps) => {
  return (
    ...
    >
      ...
      <path
        d="M315.372 306.479C321.872 330.479 307.28 363.979 280.372 363.979C259.385 363.979 237.372 329.479 245.872 306.479C247.605 301.789 256.5 341.521 280.372 316C308.5 335.021 304.28 314.489 315.372 306.479Z"
        fill="#562B30"
      />
      <defs>
        <filter
